System.register(['@angular/core', '@angular/platform-browser', '@angular/forms', '@angular/http', './app.component', './media-item.component', './media-item-list.component', './favorite.directive', './category-list.pipe', './media-item-form.component', './media-item.service', './providers', './mock-xhr-backend', './app.routing'], function(exports_1, context_1) {
    ...
    var core_1, platform_browser_1, forms_1, http_1, app_component_1, media_item_component_1, media_item_list_component_1, favorite_directive_1, category_list_pipe_1, media_item_form_component_1, media_item_service_1, providers_1, mock_xhr_backend_1, app_routing_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
